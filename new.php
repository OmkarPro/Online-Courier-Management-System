                ...
                <div class="col-md-9 register-right">
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            <h3 class="register-heading">Enter the Courier's and Receiver's Information And then Done!!!😀</h3>
                            <div class="row register-form">
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <a type="button" href="userinfo.php" class="btn btn-outline-secondary" style="margin-top:10%;margin-left:20%;background-color:red;color:yellow;">Cancel</a>
                                    </div>
                                </form>
                                <?php
